...
<div class="test-and-save">
	...
	{#if testResults.length > 0}
		...
		<div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
			...
			<div class="card">
				<div class="card-body py-3 px-4">
					<p class="text-xs text-text-tertiary">Matched</p>
					<p class="text-2xl font-bold text-success">{stats.matched}</p>
				</div>
			</div>
			<div class="card">
				<div class="card-body py-3 px-4">
					<p class="text-xs text-text-tertiary">Fehlgeschlagen</p>
					<p class="text-2xl font-bold text-error">{stats.failed}</p>
				</div>
			</div>
			<div class="card">
				<div class="card-body py-3 px-4">
					<p class="text-xs text-text-tertiary">Übersprungen</p>
					<p class="text-2xl font-bold text-warning">{stats.skipped}</p>
				</div>
			</div>
		</div>
									...
									<div>
										...
										{#if result.evaluation.constructedTitle}
											<p class="ml-2 mt-1">
												...
												<code class="bg-surface px-1 rounded">"{result.evaluation.constructedTitle}"</code>
											</p>
										{/if}
									</div>
								{/if}
	...
	<!-- Ruleset summary -->
	<details class="mt-6 rounded-lg border border-border bg-bg" open>
